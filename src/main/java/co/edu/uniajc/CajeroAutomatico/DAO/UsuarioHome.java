...
import co.edu.uniajc.CajeroAutomatico.model.Usuario;

/**
 * Home object for domain model class Usuario.
 * @see co.edu.uniajc.CajeroAutomatico.Daos.Usuario
	...
	public Usuario findById(java.lang.Integer id) {
		...
		try {
			Usuario instance = (Usuario) sessionFactory.getCurrentSession()
					.get("co.edu.uniajc.CajeroAutomatico.Daos.Usuario", id);
			if (instance == null) {
	...
	public List findByExample(Usuario instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("co.edu.uniajc.CajeroAutomatico.Daos.Usuario").add(Example.create(instance)).list();
