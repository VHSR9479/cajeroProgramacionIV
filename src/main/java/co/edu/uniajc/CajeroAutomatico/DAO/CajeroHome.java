...
import co.edu.uniajc.CajeroAutomatico.model.Cajero;

/**
 * Home object for domain model class Cajero.
 * @see co.edu.uniajc.CajeroAutomatico.Daos.Cajero
...
public class CajeroHome {
	...
	public Cajero findById(java.lang.Integer id) {
		...
		try {
			Cajero instance = (Cajero) sessionFactory.getCurrentSession()
					.get("co.edu.uniajc.CajeroAutomatico.Daos.Cajero", id);
			if (instance == null) {
	...
	public List findByExample(Cajero instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("co.edu.uniajc.CajeroAutomatico.Daos.Cajero").add(Example.create(instance)).list();
