...
import co.edu.uniajc.CajeroAutomatico.model.Producto;

/**
 * Home object for domain model class Producto.
 * @see co.edu.uniajc.CajeroAutomatico.Daos.Producto
	...
	public Producto findById(java.lang.Integer id) {
		...
		try {
			Producto instance = (Producto) sessionFactory.getCurrentSession()
					.get("co.edu.uniajc.CajeroAutomatico.Daos.Producto", id);
			if (instance == null) {
	...
	public List findByExample(Producto instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("co.edu.uniajc.CajeroAutomatico.Daos.Producto").add(Example.create(instance))
					.list();
