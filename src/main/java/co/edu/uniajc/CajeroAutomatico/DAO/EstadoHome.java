...
import co.edu.uniajc.CajeroAutomatico.model.Estado;

/**
 * Home object for domain model class Estado.
 * @see co.edu.uniajc.CajeroAutomatico.Daos.Estado
 * @author Hibernate Tools
 */
public class EstadoHome {
	...
	public Estado findById(java.lang.Integer id) {
		...
		try {
			Estado instance = (Estado) sessionFactory.getCurrentSession()
					.get("co.edu.uniajc.CajeroAutomatico.Daos.Estado", id);
			if (instance == null) {
	...
	public List findByExample(Estado instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("co.edu.uniajc.CajeroAutomatico.Daos.Estado").add(Example.create(instance)).list();
