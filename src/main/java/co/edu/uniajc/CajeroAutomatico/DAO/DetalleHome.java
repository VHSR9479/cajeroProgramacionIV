...
import co.edu.uniajc.CajeroAutomatico.model.Detalle;

/**
 * Home object for domain model class Detalle.
 * @see co.edu.uniajc.CajeroAutomatico.Daos.Detalle
...
public class DetalleHome {
	...
	public Detalle findById(co.edu.uniajc.CajeroAutomatico.DAO.DetalleHome id) {
		log.debug("getting Detalle instance with id: " + id);
		try {
			Detalle instance = (Detalle) sessionFactory.getCurrentSession()
					.get("co.edu.uniajc.CajeroAutomatico.Daos.Detalle", (Serializable) id);
			if (instance == null) {
	...
	public List findByExample(Detalle instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("co.edu.uniajc.CajeroAutomatico.Daos.Detalle").add(Example.create(instance)).list();
