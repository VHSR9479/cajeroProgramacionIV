...
import co.edu.uniajc.CajeroAutomatico.model.Transaccion;

/**
 * Home object for domain model class Transaccion.
 * @see co.edu.uniajc.CajeroAutomatico.Daos.Transaccion
	...
	public Transaccion findById(java.lang.Integer id) {
		...
		try {
			Transaccion instance = (Transaccion) sessionFactory.getCurrentSession()
					.get("co.edu.uniajc.CajeroAutomatico.Daos.Transaccion", id);
			if (instance == null) {
	...
	public List findByExample(Transaccion instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("co.edu.uniajc.CajeroAutomatico.Daos.Transaccion").add(Example.create(instance))
					.list();
